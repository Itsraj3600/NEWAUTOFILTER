...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('ᴏᴡɴ ɪɴғᴏ', url='https://t.me/+oH64M53TTQM2MTFl')
        ], [
        ...
        buttons = [[
            InlineKeyboardButton('ʀᴇᴘᴏ', url='https://t.me/+oH64M53TTQM2MTFl'),
        ...
        buttons = [[
           InlineKeyboardButton('ʀᴇᴘᴏ', url='https://t.me/+oH64M53TTQM2MTFl'),
           InlineKeyboardButton('ᴏᴡɴᴇʀ', url='https://t.me/+oH64M53TTQM2MTFl')
        ], [
            InlineKeyboardButton('ʙᴀᴄᴋ', callback_data='aswin')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
